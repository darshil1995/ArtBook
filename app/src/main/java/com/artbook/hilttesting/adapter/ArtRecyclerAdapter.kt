package com.artbook.hilttesting.adapter
...
class ArtRecyclerAdapter @Inject constructor(
    ...
    override fun onBindViewHolder(holder: ArtViewHolder, position: Int) {
        ...
        val arttistText = holder.itemView.findViewById<TextView>(R.id.artRowArtistNameText)
        ...
        holder.itemView.apply {
            ...
            arttistText.text="Artist Name: ${art.artistName}"
